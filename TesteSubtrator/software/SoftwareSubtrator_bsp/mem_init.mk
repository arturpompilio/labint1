...
$(MEM_0)_END := 0x00053fff
$(MEM_0)_SPAN := 0x00014000
$(MEM_0)_HIERARCHICAL_PATH := MemoriaImg1
$(MEM_0)_WIDTH := 8
...
.PHONY: MemoriaImg1
MemoriaImg1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: MemoriaImg2
MEM_1 := imagem2
$(MEM_1)_NAME := MemoriaImg2
...
$(MEM_1)_HIERARCHICAL_PATH := MemoriaImg2
$(MEM_1)_WIDTH := 8
...
.PHONY: MemoriaImg2
MemoriaImg2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: MemoriaPrograma
MEM_2 := SistemaEmbarcado_MemoriaPrograma
