...
# Memory: MemoriaImagem1
MEM_0 := imagem1
$(MEM_0)_NAME := MemoriaImagem1
...
$(MEM_0)_HIERARCHICAL_PATH := MemoriaImagem1
$(MEM_0)_WIDTH := 8
$(MEM_0)_HEX_DATA_WIDTH := 8
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: MemoriaImagem1
MemoriaImagem1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: MemoriaImagem2
MEM_1 := imagem2
$(MEM_1)_NAME := MemoriaImagem2
...
$(MEM_1)_END := 0x00053fff
$(MEM_1)_SPAN := 0x00014000
$(MEM_1)_HIERARCHICAL_PATH := MemoriaImagem2
$(MEM_1)_WIDTH := 8
$(MEM_1)_HEX_DATA_WIDTH := 8
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: MemoriaImagem2
MemoriaImagem2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: MemoriaPrograma
MEM_2 := SistemaEmbarcadoSubtrator_MemoriaPrograma
$(MEM_2)_NAME := MemoriaPrograma
...
$(MEM_2)_HIERARCHICAL_PATH := MemoriaPrograma
$(MEM_2)_WIDTH := 32
...
MemoriaPrograma: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
